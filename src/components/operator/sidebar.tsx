...
const NAV_ITEMS: NavItem[] = [
  ...
  {
    label: "Blacklist",
    href: (id) => `/app/blacklist/${id}`,
    icon: <ShieldIcon />,
    requiresCompany: true,
  },
  {
    label: "Invoices",
    href: (id) => `/app/invoices/${id}`,
    icon: <InvoiceIcon />,
    requiresCompany: true,
  },
  {
  ...
  return (
    <aside className="flex h-screen w-60 shrink-0 flex-col border-r border-border bg-white">
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-3">
        ...
        {/* Admin switch — only visible to admin accounts */}
        {ADMIN_EMAILS.includes(user.email.toLowerCase()) && (
          <div className="mt-6">
            ...
            >
              <span className="h-4 w-4 shrink-0 text-neutral-400">
                <AdminIcon />
              </span>
              Admin pipeline
            </Link>
...
// Icons
function TodayIcon() {
  return <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-4 w-4"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" /></svg>;
}
function GridIcon() {
...
function ShieldIcon() {
  return <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-4 w-4"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z" /></svg>;
}
...
function InvoiceIcon() {
  return <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-4 w-4"><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25M9 12.75h6M9 15.75h3M9.75 3H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" /></svg>;
}
